...
\begin{document}
	...
	\section{Scheduling for Remainder of Semester}
		...
		\subsection{Identification of Risk}
			
			\begin{enumerate}
				\item Image processing to stitch images together to get 100\% of information in one frame \\\textbf{Risk Level: High}
				\item Image processing to identify information on a white board \\\textbf{Risk Level: High}
				\item 
			\end{enumerate}
